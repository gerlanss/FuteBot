...
ODDSPAPI_SIMPLE_WATCH_MIN_EV_PERCENT = _get_env_float("ODDSPAPI_SIMPLE_WATCH_MIN_EV_PERCENT", 2.0)
LIVE_PRICE_WATCH_WINDOW_MIN = _get_env_int("LIVE_PRICE_WATCH_WINDOW_MIN", 15)
LIVE_PRICE_WATCH_RECHECK_MIN = _get_env_int("LIVE_PRICE_WATCH_RECHECK_MIN", 5)
...
LIVE_CHECK_INTERVALO_MIN = _get_env_int("LIVE_CHECK_INTERVALO_MIN", 3)
PREDICTOR_MAX_LIGAS_CACHE = _get_env_int("PREDICTOR_MAX_LIGAS_CACHE", 0)
...
DISCOVERY_TARGET_PRECISION = _get_env_float("DISCOVERY_TARGET_PRECISION", 0.75)
DISCOVERY_TARGET_PRECISION_COPA = _get_env_float("DISCOVERY_TARGET_PRECISION_COPA", 0.75)
DISCOVERY_MIN_TRAIN_SAMPLES = _get_env_int("DISCOVERY_MIN_TRAIN_SAMPLES", 30)
DISCOVERY_MIN_TRAIN_SAMPLES_COPA = _get_env_int("DISCOVERY_MIN_TRAIN_SAMPLES_COPA", 20)
DISCOVERY_MIN_TEST_SAMPLES = _get_env_int("DISCOVERY_MIN_TEST_SAMPLES", 10)
DISCOVERY_MIN_TEST_SAMPLES_COPA = _get_env_int("DISCOVERY_MIN_TEST_SAMPLES_COPA", 6)
